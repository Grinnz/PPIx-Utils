...
These functions were originally from L<Perl::Critic::Utils> and
L<Perl::Critic::Utils::PPI>, and have been split off to this distribution for
use outside of L<Perl::Critic>.
